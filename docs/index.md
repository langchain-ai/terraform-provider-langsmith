...
Deployment resources and revision data sources use `/v2/deployments` on the same
LangSmith API endpoint as other resources. Select the endpoint with `api_url`,
`LANGSMITH_ENDPOINT`, or a LangSmith CLI profile.
